...
#Soil pH
ggplot(data = thesis_data, aes(x = Treatment, y = MEANpH, fill = Treatment)) +
  geom_boxplot(alpha = 0.8) +
  facet_grid(~factor(Season, levels=c('Summer', 'Heatwave', 'Autumn warm', 'Autumn cold')))+
  labs(x = "Treatment",
       y = "Soil pH") +
...
#Soil Moisture
ggplot(data = thesis_data, aes(x = Treatment, y = MeanSoilMoisture, fill = Treatment)) +
  geom_boxplot(alpha = 0.8) +
  facet_grid(~factor(Season, levels=c('Summer', 'Heatwave', 'Autumn warm', 'Autumn cold')))+
  labs(x = "Treatment",
       y = "Soil Moisture") +
...
my_prior_gcc <- c(my_prior_gcc,set_prior("normal(0,0.04)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
...
my_prior_height <- c(my_prior_height,set_prior("normal(0,15)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
...
my_prior_pH <- c(my_prior_pH,set_prior("normal(0,1)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
...
my_prior_moisture <- c(my_prior_moisture,set_prior("normal(0,1)",class = "b",coef = "SeasonHeatwave:TreatmentHeatwave"))
my_prior_moisture <- c(my_prior_moisture,set_prior("normal(0,2)",class = "b",coef = "SeasonSummer:TreatmentHeatwave"))

my_prior_moisture <- c(my_prior_moisture,set_prior("normal(0,1)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
my_prior_moisture <- c(my_prior_moisture,set_prior("normal(0,1)",class = "b",coef = "SeasonHeatwave:TreatmentExtended"))
...
my_prior_evapotranspiration <- c(my_prior_evapotranspiration,set_prior("normal(0,1.5)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
...
my_prior_co2_linear <- c(my_prior_co2_linear,set_prior("normal(0,1)",class = "b",coef = "meanGCC_scale"))
...
my_prior_co2_cover_linear <- c(my_prior_co2_cover_linear,set_prior("normal(0,1)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
my_prior_co2_cover_linear <- c(my_prior_co2_cover_linear,set_prior("normal(0,1)",class = "b",coef = "SeasonHeatwave:TreatmentExtended"))
my_prior_co2_cover_linear <- c(my_prior_co2_cover_linear,set_prior("normal(0,1)",class = "b",coef = "SeasonSummer:TreatmentExtended"))

# prior of the slopes of the continuous variables
my_prior_co2_cover_linear <- c(my_prior_co2_cover_linear,set_prior("normal(0.1,0.1)",class = "b",coef = "averageTemp_scale"))
my_prior_co2_cover_linear <- c(my_prior_co2_cover_linear,set_prior("normal(0,1)",class = "b",coef = "Cover_scale"))
