...
my_prior_gcc <- c(my_prior_co2,set_prior("normal(0,0.08)",class = "b",coef = "SeasonSummer:TreatmentHeatwave"))

my_prior_gcc <- c(my_prior_co2,set_prior("normal(0,0.08)",class = "b",coef = "SeasonAutumnwarm:TreatmentExtended"))
my_prior_gcc <- c(my_prior_co2,set_prior("normal(0,0.08)",class = "b",coef = "SeasonHeatwave:TreatmentExtended"))
my_prior_gcc <- c(my_prior_co2,set_prior("normal(0,0.08)",class = "b",coef = "SeasonSummer:TreatmentExtended"))
